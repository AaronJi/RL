...
class LIRDAgent(Agent):

    def __init__(self, hyperparams):
        super(LIRDAgent, self).__init__(hyperparams)
        self.actor = None
        self.critic = None
        return
    ...
    def init(self, environment, batch_size):
        ...
        self.actor = Actor(self._hyperparams, environment.item_embeddings)
        self.critic = Critic(self._hyperparams)
        return
